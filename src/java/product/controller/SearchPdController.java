 ...
 * @author lequa
 */
@WebServlet(name = "SearchPdController", urlPatterns = {"/SearchPdController"})
public class SearchPdController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            List<Product> ProductList = pdao.getListProduct(searchPd);
